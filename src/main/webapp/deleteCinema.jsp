...
//Intento ver si me ha puesto los datos para añadir un nuevo cine
	Cinema c = null;
	try{
		c = CineRepository.getCinema(request.getParameter("cineBorrar"));
	...
	%>
		<form>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-8">
		      <input id="ciudad" name="direccion" type="text" class="form-control" value='<%=c.getDireccionCine() %>' readonly>
		    </div>
		  </div> 
		  <div class="form-group row">
